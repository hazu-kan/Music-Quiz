...
class UserEnterQuiz:
    ...
    def __init__(self, parent):
        self.heading = Label(parent, text='THE MUSIC QUIZ',
        ...
        self.username_label = Label(parent, text='Enter Username Here:'
                                    , font=('Helvetica', '15'),
                                    bg='#07989d', fg='white')
        ...
        self.entry_box = Entry(parent, font=('Times 20 italic bold',
                               '20'))
...
# questions storage, tells the quiz about question, image and options
        ...
        self.questions_answers = {
            1: [
                'How many studio albums have the k-pop group blackpink  released?'
                    ,
                '4',
                '8',
                '2',
            ...
            2: [
                "What is the Weeknd's 4th album?",
                'Kissland',
                'My Dear melonchy',
                'Dawn FM',
            ...
            3: [
                'Who starrred in the music video Out of Time by the Weeknd?'
                    ,
                'HoYeon Jung',
                'Lee Jung-jae',
                'Jeffrey Su',
            ...
            7: [
                'What is Drakes most streamed song to date?',
                'Gods Plan',
                'Hotline Bling',
                'One Dance',
                'In my Feelings',
            ...
            10: [
                'Which mathematical symbol was the title of Ed Sheeran\xe2\x80\x99s first album in 2011?'
                    ,
                '+',
                '-',
                'x',
...
# the buttons and labels for the question screen
        ...
        self.title_label = Label(parent, text='The Music Quiz',
                                 font=('Courier', '18', 'bold'),
                                 bg='#07989d', fg='white')
        self.title_label.place(x=385, y=60)  # title

    # question

        self.question_label = Label(parent,
                                    text=self.questions_answers[qnum][0],
                                    font=('Tw Cen MT', '10', 'bold'),
                                    bg='#07989d', fg='white')
...
# confirm button
      ...
      # score
        ...
        self.score_label = Label(parent, text='Score', font=('Helvetica'
                                 , '15'), bg='#07989d', fg='white')
        self.score_label.place(x=300, y=10)

        self.answer_label = Label(parent, font=('Courier', '10'),
                                  fg='white', bg='#07989d')
...
# configs the buttons and titles to fit the new question
    ...
    def tester(self):
        ...
        if len(asked) > 10:  # to determine if its the last question and just end the quiz after
            if choice == self.questions_answers[qnum][6]:
                ...
                score += 0
                score_label.configure(text=' NO!...The correct answer is'
                         + self.questions_answers[qnum][5])
                self.confirm_button.config(text='Confirm')
                self.endScreen()
        else:
...
# window
        ...
        self.end_frame = Frame(self.end_window, width=1000,
                               height=1000, bg=background)
        self.end_frame.grid(row=0)

# heading

        self.end_heading = Label(self.end_frame, text='Well Done',
                                 font=('Tw Cen MT', 22, 'bold'),
                                 bg=background, pady=10)
        self.end_heading.grid(row=0)

        self.leader_button = Button(
            self.end_frame,
            text='Exit',
            width=10,
            bg='#07989d',
